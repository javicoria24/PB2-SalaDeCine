...
public class Main {
	...
	private static void inicializarSistema() {
		...
		System.out.println("Sala de  + x " + " creada exitosamente.");
	...
	private static void mostrarButacasDetalle(SalaCine sala2) {
		System.out.println(sala2.getButacas());
	...
	private static void venderBoleto() {
		...
		boolean exito = sala.venderBoleta(nombreComprador, asiento, edad);

		if (exito) {
			System.out.println("🎉 ¡Boleto vendido exitosamente!");
			System.out.println(sala.getButacas());
		} else {
	...
	private static void liberarAsiento() {
		...
		System.out.print("Ingrese el numero  del asiento a liberar: ");
		int numero = scanner.nextInt();
		System.out.print("Ingrese el nombre del ocupante del asiento a liberar: ");
		String nombre = scanner.next();

		boolean exito = sala.liberarAsiento(numero, nombre);
